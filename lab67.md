...
MOCK для мокирования курса валют, то есть MOCK позволяет не обращаться каждый раз к внешнему ресурсу для получения курса валют. 

В данном примере MOCK сервис должен не просто работать, но и возвращать курс валюты по API запросу.

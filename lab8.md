...
Нужно по максимуму использовать Framework (не нужно писать свой). Запуск тестов и чтение тестовых данных в большинстве случаев может делаться стандартными методами, реализованными в Framework.
